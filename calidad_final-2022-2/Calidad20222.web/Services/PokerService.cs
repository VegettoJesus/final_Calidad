...
{   
    public const String CARTA_MAYOR = "CARTA ALTA";
    public const String DOBLE = "PAREJA";
    ...
    public const String ESCALERA_COLOR = "ESCALERA_COLOR";
    ...
    private bool EsEscaleraColor(List<Carta> cartas)
    {
        ...
        {
            if ((cartas.ElementAt(i).Numero + 1 != cartas.ElementAt(i + 1).Numero)&& grouping.Count() != 1)
                return false;
        }
        return true;
    }
